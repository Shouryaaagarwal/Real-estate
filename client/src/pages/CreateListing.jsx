...
//         });
//     } else {
//       setimageUploaderror("Youn can upload only 6 images");
//     }
//   };
...
//                 />  
//                 <button type='button' onClick={()=>handleRemoveImage(index)} className="text-red-700 p-3 rounded-lg hover:opacity-75 uppercase">Delete</button>
